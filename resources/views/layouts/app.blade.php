...
<div id="app" >
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: black !important; color:white">
        <div class="container">
            <a style="color:#e50914" class="navbar-brand" href="{{ url('/') }}">

                {{--  {{ config('app.name', 'Laravel') }}  --}}
                <strong> Vimajor  @yield('title')</strong>
            </a>
