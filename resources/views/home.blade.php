            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        @if(Auth::user()->hasRole('loaders'))

                            <a href="{{route('video.create')}}" class="btn btn-blue añadir" >Añadir video</a>


                        @endif

                        <a href="{{route('profiles.myprofile')}}" class="btn btn-blue añadir" >Ver Perfil</a>
